    ...
    return <div>
        ...
        <div class="text-s tooltip">(?)
            <span class="tooltip-text">
                ...
                <p>multiple different conditions can be joined by AND or OR conditions using the &amp; and | operators, respectively
                (operators are evaluated in a left to right manner, but parentheses can be used to force an alternative evaluation order).</p>
                <br></br>
                examples:
                <ul class="list-disc list-inside">
                    ...
                    <li> <pre class="inline">FTL = 0 &amp; APOE &lt; 4 | 2 &lt; RHOB</pre> : only shows a cell if it has no expression of FTL and expression of APOE below 4 or if the cell has expression of RHOB above 2</li>
                    <li> <pre class="inline">FTL = 0 &amp; (APOE &lt; 4 | 2 &lt; RHOB)</pre> : only shows a cell if it has no expression of FTL while it also has expression of APOE below 4 or expression of RHOB above 2</li>
                </ul>
                <br></br>
                <p>important note: the two last queries differ in meaning due to precendence of operators, use parentheses to force order of evaluation</p>
            </span>
        </div>
        <br></br> <br></br>
        <div>
